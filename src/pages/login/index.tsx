          ...
          items={[
            {
              ...
              children: (
                <>
                  <Typography.Paragraph type="secondary">支持用户名、手机号或邮箱登录。本地默认账号：admin / admin123</Typography.Paragraph>
                  <Form<LoginForm> layout="vertical" onFinish={handleSubmit} initialValues={{ account: 'admin' }}>
                    <Form.Item name="account" label="账号" rules={[{ required: true, message: '请输入用户名、手机号或邮箱' }]}>
                      <Input prefix={<UserOutlined />} placeholder="admin / 13800000000 / name@example.com" />
                    </Form.Item>
